...
export const NoteView = () => {
    ...
    return (
        <Grid
            ...
            <Grid item>
                {/* Este input es para subir archivo y lo escondo porque es feo 
                Luego con el "ref" lo que hago esque ese boton haga referencia a iconbutton 
                mediante un evento */}
                <input type="file" multiple onChange={onFileInputChange} style={{display:'none'}}
                ref={fileInputRef}
                />
